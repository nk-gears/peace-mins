  ...
  return (
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          ...
          <div className="">
            ...
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              <a
                href="https://twitter.com/BrahmaKumarisTN"
                target="_blank"
                rel="noopener">
              ...
              <a
                href="https://https://facebook.com/BrahmaKumarisTAM"
                target="_blank"
                rel="noopener">
              ...
              <a
                href="https://instagram.com/BrahmaKumarisTAM"
                target="_blank"
                rel="noopener">
              ...
              <a
                href="https://youtube.com/@brahmakumaristam"
                target="_blank"
                rel="noopener">
        ...
        ©Copyright - Brahma Kumaris - TN Zone | {new Date().getFullYear()}.
...
const Youtube = ({ size = 24 }) => (
 ...
 height={size}
 viewBox="0 0 24 24"    strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"> <path stroke="none" d="M0 0h24v24H0z" fill="none"/> <rect x="3" y="5" width="18" height="14" rx="4" /> <path d="M10 9l5 3l-5 3z" /> </svg>
);
